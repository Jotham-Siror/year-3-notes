...
**Expected:** further handouts in the same series (*Wave Characteristics II*, …), released
progressively through the semester. Add a row as each arrives, and a matching entry in the handout
register in `../knowledge-base/00-index.md`.
